            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.heroSection}>
                    <View style={styles.heroIconContainer}>
                        <FontAwesome5 name="hand-holding-heart" size={50} color="#1a56db" />
                    </View>
...
const styles = StyleSheet.create({
    ...
    heroSection: {
        marginHorizontal: 20, marginTop: 10, marginBottom: 25, padding: 25,
        borderRadius: 16, alignItems: 'center', backgroundColor: '#fff',
        shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
        shadowOpacity: 0.06, shadowRadius: 8, elevation: 3,
    },
    heroIconContainer: { width: 100, height: 100, backgroundColor: '#eff6ff', borderRadius: 50, justifyContent: 'center', alignItems: 'center', marginBottom: 15 },
    ...
    topicCard: {
        width: '48%', padding: 15, borderRadius: 16, marginBottom: 15, backgroundColor: '#fff',
        shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
        shadowOpacity: 0.06, shadowRadius: 8, elevation: 3,
    },
    ...
    tipCard: {
        flexDirection: 'row', padding: 16, borderRadius: 16, marginBottom: 12, backgroundColor: '#fff',
        shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
        shadowOpacity: 0.06, shadowRadius: 8, elevation: 3,
    },
    ...
    emergencySection: { marginHorizontal: 20, padding: 20, borderRadius: 16, marginBottom: 20, backgroundColor: '#FFE5E5' },
    ...
    emergencyDescription: { fontSize: 13, color: '#6b7280' },
